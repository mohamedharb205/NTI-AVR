...
{
	LCD_voidWriteCharacterAtXY('\0' , copy_u8Ypos , copy_u8Xpos);
}
...
void LCD_voidWriteString(s8* copy_pu8String)		// Convert the string data type into s8 instead of u8 to clear the warning
{
...
void LCD_voidWriteStringAtXY(s8* copy_pu8String, u8 copy_u8YPos , u8 copy_u8XPos)
{
	LCD_voidGoToXY(copy_u8YPos, copy_u8XPos);
