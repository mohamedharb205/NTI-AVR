...
#define HAL_LCD_LCD_CONFIG_H_
	...
	/* LCD CONFIGURATIONS */
		/* LCD connection type configuration macro , select between :  1- LCD_FOUR_BIT_MODE  2- LCD_EIGHT_BIT_MODE */
		#define			CONNECTION_MODE				LCD_FOUR_BIT_MODE

		/* CLCD Read Operation Enable Configuration , select between :  1- LCD_ENABLED	 2- LCD_DISABLED */
