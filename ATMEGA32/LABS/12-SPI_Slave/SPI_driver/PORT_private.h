...
#define 		PORTA_VAL									CONC(PORTA_PIN7_V,PORTA_PIN6_V,PORTA_PIN5_V,PORTA_PIN4_V,PORTA_PIN3_V,PORTA_PIN2_V,PORTA_PIN1_V,PORTA_PIN0_V)
#define 		PORTB_VAL									CONC(PORTB_PIN7_V,PORTB_PIN6_V,PORTB_PIN5_V,PORTB_PIN4_V,PORTB_PIN3_V,PORTB_PIN2_V,PORTB_PIN1_V,PORTB_PIN0_V)
#define 		PORTC_VAL									CONC(PORTC_PIN7_V,PORTC_PIN6_V,PORTC_PIN5_V,PORTC_PIN4_V,PORTC_PIN3_V,PORTC_PIN2_V,PORTC_PIN1_V,PORTC_PIN0_V)
#define 		PORTD_VAL									CONC(PORTD_PIN7_V,PORTD_PIN6_V,PORTD_PIN5_V,PORTD_PIN4_V,PORTD_PIN3_V,PORTD_PIN2_V,PORTD_PIN1_V,PORTD_PIN0_V)
